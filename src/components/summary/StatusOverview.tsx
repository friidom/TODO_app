  ...
  return (
    ...
    >
      {total === 0 ? (
        ...
        <div className="flex flex-col items-center gap-5 px-4 pb-4 sm:flex-row sm:items-center sm:gap-6">
          <div className="relative shrink-0">
              ...
              {arcs.map((arc) => {
                ...
                return (
                  <circle
                    ...
                    strokeWidth="4"
                    stroke="currentColor"
                    // The circumference at r=15.9155 is 100, so the dash array
                    // is already a percentage and needs no conversion.
            ...
            {/* Centred over the ring rather than inside the SVG: a foreignObject
                would not inherit the page's font, and a <text> would not wrap. */}
            ...
            {slices.map((slice) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Raw, never through `t()`: a column title is user-editable
                      text, and running it through i18n was the M2-20 bug that
                      made a column called "todo" render as a translation key. */}
                  ...
                  <span className="text-ink-3 w-9 shrink-0 text-right text-[11px] tabular-nums">
