      ...
      {showAdd && (
        <>
          ...
          <button
            ...
            className="pointer-events-none absolute top-1/2 -left-2 z-10 flex size-6 -translate-y-1/2 items-center justify-center rounded-md border border-hairline bg-elevated text-ink-2 opacity-0 shadow-sm transition-opacity duration-100 group-hover:pointer-events-auto group-hover:opacity-100"
          >
            <Plus size={15} />
          </button>
        </>
