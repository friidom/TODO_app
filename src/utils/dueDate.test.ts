...
// due_date is timestamptz — every value arrives as a full ISO instant even though the product only means a day
...
describe("todayISO", () => {
  ...
  it("reads local calendar components, not UTC ones", () => {
    // toISOString() here would return the 21st for anywhere east of Greenwich
...
describe("dueStatus", () => {
  ...
  // comparing the raw stored string against "2026-08-13" would sort it after — a card due today read as upcoming
...
describe("formatDue", () => {
  ...
  // formatting in UTC stops midnight-UTC rendering as the previous day for a viewer west of Greenwich
